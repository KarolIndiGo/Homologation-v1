...
-- Schema: ViewInternal
-- Object: VW_IMO_HISTORICO_NOMINA
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.IMO_HISTORICO_NOMINA
AS 
...
(SELECT sum(AccruedValue) FROM [INDIGO035].[Payroll].[LiquidationDetail] where PayrollId = L.Id and ConceptCode = '001') as SueldoPagado, 
...
(SELECT ISNULL(sum(ConceptTotalValue),0) FROM [INDIGO035].[Payroll].[LiquidationDetail] where PayrollId = L.Id and ConceptCode = '108') as EmbargosJudiciales,
