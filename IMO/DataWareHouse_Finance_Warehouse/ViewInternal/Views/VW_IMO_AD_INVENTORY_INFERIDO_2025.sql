...
-- Schema: ViewInternal
-- Object: VW_IMO_AD_INVENTORY_INFERIDO_2025
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE   VIEW ViewInternal.VW_IMO_AD_INVENTORY_INFERIDO_2025
AS
...
FROM (SELECT PROD.Sucursal,
			...
			+isnull (sum (ALMA.[109]), 0) 
             ...
             + CASE WHEN SUM (PROD.Dic24) > 0 THEN 1 ELSE 0 END AS Rotacion --+
      ...
      FROM (SELECT 
            ...
            FROM (SELECT Ene24,
                         ...
                         [Código Agrupador],
                         [Agrupador]
                  FROM [ViewInternal].[VW_IMO_AD_INVENTORY_INFERIDO_INVENTARIO_PRODUCTO_2025]
                       AS PROD) AS PROD
...
[108],[109],
                         CostoPromedio,
                         [Código Agrupador]
                  FROM [ViewInternal].[VW_IMO_AD_INVENTORY_ALMACENESPIVOT]
