...
-- Schema: ViewInternal
-- Object: VW_IMO_ESTADOSFINANCIEROS_PTO_2025
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[IMO_EstadosFinancieros_Pto_2025]
AS
...
SELECT { fn CONCAT(c.Number, cco.Code) } AS Llave, 
		...
		CASE WHEN sc.Month = '1' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1,  CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Enero25, 
		CASE WHEN sc.Month = '2' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Febrero25, 
		CASE WHEN sc.Month = '3' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Marzo25, 
		CASE WHEN sc.Month = '4' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Abril25, 
		CASE WHEN sc.Month = '5' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Mayo25, 
		CASE WHEN sc.Month = '6' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Junio25, 
		CASE WHEN sc.Month = '7' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Julio25, 
		CASE WHEN sc.Month = '8' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Agosto25, 
		CASE WHEN sc.Month = '9' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Septiembre25, 
		CASE WHEN sc.Month = '10' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Octubre25, 
		CASE WHEN sc.Month = '11' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Noviembre25, 
		CASE WHEN sc.Month = '12' AND sc.Year = '2025' THEN IIF(cl.Nature <> c.Nature, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4))) * - 1, IIF(c.Nature = 1, CAST((SUM(sc.DebitValue) - SUM(sc.CreditValue)) AS DECIMAL(19,4)), CAST((SUM(sc.CreditValue) - SUM(sc.DebitValue)) AS DECIMAL(19,4)))) * IIF(cl.Nature = 2, - 1, 1) END AS Diciembre25, 
...
WHERE c.LegalBookId = '1' and cl.Code IN (4,5,6) and cco.Name Like 'PIT%' --and t .Nit='901127065'
