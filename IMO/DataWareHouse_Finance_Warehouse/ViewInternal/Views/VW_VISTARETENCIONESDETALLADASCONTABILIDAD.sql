...
from [INDIGO035].[GeneralLedger].[JournalVoucherDetails] jvd
inner join [INDIGO035].[GeneralLedger].[MainAccounts] ma on ma.Id = jvd.IdMainAccount
inner join [INDIGO035].[GeneralLedger].[JournalVouchers] jv on jv.Id = jvd.IdAccounting
left join [INDIGO035].[Common].[ThirdParty] t on t.Id = jvd.IdThirdParty
left join [INDIGO035].[GeneralLedger].[RetentionConcepts] rc on rc.Id = jvd.IdRetention
