...
-- Schema: ViewInternal
-- Object: VW_IMO_AD_INVENTORY_INFERIDO_2024
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE   VIEW [ViewInternal].[VW_IMO_AD_INVENTORY_INFERIDO_2024]
AS
...
FROM (SELECT PROD.Sucursal,
      ...
      FROM (SELECT 
            ...
            FROM (SELECT Ene23,
                         ...
                         [Código Agrupador],
                         [Agrupador]
                  FROM [ViewInternal].[VW_IMO_AD_INVENTORY_INFERIDO_INVENTARIO_PRODUCTO_2024]
                       AS PROD) AS PROD
