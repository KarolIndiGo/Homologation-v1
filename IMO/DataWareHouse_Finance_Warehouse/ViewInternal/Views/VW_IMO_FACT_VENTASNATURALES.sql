...
-- Schema: ViewInternal
-- Object: VW_IMO_FACT_VENTASNATURALES
...
FROM [INDIGO035].[GeneralLedger].[GeneralLedgerBalance] AS sc 
    ...
    LEFT OUTER JOIN [INDIGO035].[Payroll].[CostCenter] AS cco ON cco.Id = sc.IdCostCenter
    LEFT OUTER JOIN [INDIGO035].[GeneralLedger].[MainAccounts] AS c ON c.Id = sc.IdMainAccount
