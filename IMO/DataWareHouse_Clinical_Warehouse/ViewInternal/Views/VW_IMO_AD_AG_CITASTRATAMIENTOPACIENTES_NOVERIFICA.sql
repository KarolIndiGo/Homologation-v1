...
-- Schema: ViewInternal
-- Object: VW_IMO_AD_AG_CITASTRATAMIENTOPACIENTES_NOVERIFICA
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.IMO_AD_AG_CitasTratamientoPacientes_NoVerifica
AS
...
FROM [INDIGO035].[dbo].[AGASICITA] AS A
	...
	LEFT JOIN [INDIGO035].[dbo].[INMUNICIP] AS mu LEFT JOIN [INDIGO035].[dbo].[INDEPARTA] AS DEP ON DEP.depcodigo = mu.DEPCODIGO ON mu.DEPMUNCOD = UB.DEPMUNCOD ON UB.AUUBICACI = B.AUUBICACI
    LEFT JOIN
    (
