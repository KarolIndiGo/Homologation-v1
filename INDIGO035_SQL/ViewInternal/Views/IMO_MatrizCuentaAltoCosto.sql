...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IMO_MatrizCuentaAltoCosto
-- Extracted by Fabric SQL Extractor SPN v3.9.0

--/****** Object:  View [ViewInternal].[IMO_MatrizCuentaAltoCosto]    Script Date: 11/07/2025 8:23:23 a. m. ******/
--SET ANSI_NULLS ON
--GO

--SET QUOTED_IDENTIFIER ON
--GO
CREATE VIEW [ViewInternal].[IMO_MatrizCuentaAltoCosto] AS
select 
				A.Id, 
				--A.CODDIAGNO, 
				--A.IDEntidadVIE, 
