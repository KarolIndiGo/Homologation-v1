...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IMO_Listado_Talento_Humano
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[IMO_Listado_Talento_Humano] AS
...
FROM Payroll.Employee AS E
		...
		LEFT OUTER JOIN (select MAX(id) as idciu, IdPerson 
from Common.Address 
group by IdPerson) AS DE ON  de.IdPerson = p.Id
		LEFT OUTER JOIN Common.Address AS d ON d.id = DE.idciu
