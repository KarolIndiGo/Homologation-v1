...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IMO_AD_FixedAsset_BajaActivos
-- Extracted by Fabric SQL Extractor SPN v3.9.0


create VIEW [ViewInternal].[IMO_AD_FixedAsset_BajaActivos]
AS
SELECT 
...
FROM     FixedAsset.FixedAssetActiveOutputDetail AS DB  INNER JOIN
                  ...
                  ViewInternal.IMO_AD_Fixed_RelaciónActivos_Vie AS RA  ON RA.Placa = pa.Plate
