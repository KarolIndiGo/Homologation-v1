...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IMO_AD_Inventory_Inferido_2025
...
CREATE VIEW [ViewInternal].[IMO_AD_Inventory_Inferido_2025]
AS
SELECT Sucursal,
       Cod_Producto,
       Producto,
...
FROM (SELECT PROD.Sucursal,
      ...
      FROM (SELECT 
            ...
            FROM (SELECT Ene24,
                         ...
                         [Código Agrupador],
                         [Agrupador]
                  FROM [ViewInternal].[IMO_AD_Inventory_Inferido_Inventario_Producto_2025]
                       AS PROD) AS PROD
