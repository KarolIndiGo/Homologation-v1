...
CASE C.ACTIVICON WHEN 0 THEN 'Consulta Externa' WHEN 1 THEN 'Procedimiento Qx' WHEN 2 THEN 'Apoyo Diagnóstico' WHEN 3 THEN 'Tratamientos Especiales' WHEN 4 THEN 'Diálisis' END AS Cita,
    ...
    CASE
        WHEN B.IPTIPODOC = '1' THEN
            'Cedula de Ciudadania'
        WHEN B.IPTIPODOC = '2' THEN
            'Cedula de Extranjeria'
        WHEN B.IPTIPODOC = '3' THEN
            'Tarjeta de Identidad'
        WHEN B.IPTIPODOC = '4' THEN
            'Registro Civil'
        WHEN B.IPTIPODOC = '5' THEN
            'Pasaporte'
        WHEN B.IPTIPODOC = '6' THEN
            'Adulto sin Identificacion'
        WHEN B.IPTIPODOC = '7' THEN
  ...
  CASE 
    WHEN A.CODTIPCIT = '0' THEN
        '1aVez'
    WHEN A.CODTIPCIT = '1' THEN
        'Control'
    WHEN A.CODTIPCIT = '2' THEN
        'PosOperatorio'
    WHEN A.CODTIPCIT = '3' THEN
        'Cita Web'
    WHEN A.CODTIPCIT = '4' THEN
        'Extra'
...
END AS EstiloCita,
  ...
  --  m.Mes,
    ...
    CASE
        WHEN CO.CODPROSAL = A.CODPROSAL THEN
            CO.NUMINGRES
        ELSE
            '0'
    END AS IngresoCita,
	...
	b.CORELEPAC as CorreoPaciente, TP.NIT
--select A.*
FROM dbo.AGASICITA AS A
    ...
    LEFT OUTER JOIN dbo.INPROFSAL AS D
		...
		LEFT JOIN dbo.AGCONSULTORIO AS H2
        ON H2.CODIGO = A.CODIGOCON
    LEFT JOIN dbo.AGCONSULT AS H
...
WHERE --(A.CODCENATE IN ( '001', '002' ))      AND 
	  (A.FECHORAIN)>='01-01-2022'
...
'3131', '3333', '333333', '3131', '3333', '333333', '55555', '3333', '333333', '0000', '33333', '3131', '55555', '3333', '0000', '3131', '33333', '55555', '0000000', '3333', '333333', '3131', '33333' )) --and a.ipcodpaci='83233455'
