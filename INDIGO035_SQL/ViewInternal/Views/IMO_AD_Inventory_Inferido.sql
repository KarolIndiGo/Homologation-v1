...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IMO_AD_Inventory_Inferido
-- Extracted by Fabric SQL Extractor SPN v3.9.0



create VIEW [ViewInternal].[IMO_AD_Inventory_Inferido]
AS
SELECT Sucursal,
       Cod_Producto,
       Producto,
...
FROM (SELECT PROD.Sucursal,
      ...
      FROM (SELECT 
            ...
            FROM (SELECT Ene22,
                         ...
                         [Código Agrupador],
                         [Agrupador]
                  FROM [ViewInternal].[IMO_AD_Inventory_Inferido_Inventario_Producto_2022]
                       AS PROD) AS PROD
