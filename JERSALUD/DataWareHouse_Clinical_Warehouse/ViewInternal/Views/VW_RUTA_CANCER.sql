...
-- Schema: ViewInternal
-- Object: VW_RUTA_CANCER
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VW_RUTA_CANCER]
AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2024' and CUPS.Code in ('906611','906612','906610') and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) >= '25'   
