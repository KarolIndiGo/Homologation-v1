...
-- Schema: ViewInternal
-- Object: VW_IND_INDICADOR_INTERCONSULTAS_PB
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_IND_INDICADOR_INTERCONSULTAS_PB 
AS
...
INNER JOIN [INDIGO031].[dbo].[INESPECIA] AS EI  ON I.CODESPECI = EI.CODESPECI
inner join [INDIGO031].[dbo].[INCUPSIPS] as cu on cu.CODSERIPS=I.CODSERIPS
LEFT OUTER JOIN [INDIGO031].[dbo].[INESPECIA] AS E  ON M.CODESPEC1 = E.CODESPECI
...
INNER JOIN [INDIGO031].[dbo].[ADINGRESO] AS IG  ON IG.NUMINGRES = I.NUMINGRES AND YEAR(IG.IFECHAING) >= '2023'
