...
-- Schema: ViewInternal
-- Object: VW_IND_INDICADORESGRALXPROFESIONAL_IMAGENESDX_TARIFA_PB
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_IND_INDICADORESGRALXPROFESIONAL_IMAGENESDX_TARIFA_PB 
as
...
LEFT JOIN [INDIGO031].[ViewInternal].[Tarifas_Imagenologia] AS T ON T.Code=I.CODSERIPS
