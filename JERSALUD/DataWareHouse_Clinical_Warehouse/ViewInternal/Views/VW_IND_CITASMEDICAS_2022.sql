...
-- Schema: ViewInternal
-- Object: VW_IND_CITASMEDICAS_2022
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_IND_CITASMEDICAS_2022
AS
...
LEFT OUTER JOIN [INDIGO031].[dbo].[ADINGRESO] as ING on  PA.IPCODPACI = ING.IPCODPACI
