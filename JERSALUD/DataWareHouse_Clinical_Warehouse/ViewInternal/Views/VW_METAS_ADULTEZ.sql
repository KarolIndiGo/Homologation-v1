...
-- Schema: ViewInternal
-- Object: VW_METAS_ADULTEZ
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VW_METAS_ADULTEZ]
AS
...
SELECT DISTINCT
       ...
       case
           when F.OutputDiagnosis in ('Z000','Z008','Z136','Z108') and CUPS.Code in ('890263','890363','890201','890301') then 'Nroatenciones_GralAdultez' 
           when F.OutputDiagnosis in (
           ...
           when F.OutputDiagnosis not in (
                'I10X','E660','E668','E669','E100','E101','E102','E103','E104','E105','E106','E107','E108','E109','E110','E111','E112','E113','E114','E115',
           ...
           ) and CUPS.Code in ('903841') then 'RiesgoCardioAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('903815') then 'RiesgoCardio_AltaAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('903816','903817') then 'RiesgoCardio_BajaAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('903818') then 'RiesgoCardio_TotalAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('903868') then 'TrigliceridosAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('903895') then 'CreatininaAdultez'
           ...
           when F.OutputDiagnosis not in (
                ...
                'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
                'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789'
           ) and CUPS.Code in ('907106') then 'UroanalisisAdultez'  
...
WHERE  (SOD.ServiceDate) >= '01/01/2024'
  and CUPS.Code in (
      '990101','990102','990103','990104','990105','990106','990107','990108','990109','990110','990111','990112','990113',
      '990202','990203','990204','990205','990206','990207','990208','990209','990210','990211','997301','997002','906263','906225','906317','906249','906039',
      '907106','903895','903868','903818','903816','903817','903815','907009','890301','890294','890201',
  ...
  and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) >= '29'
  and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) <= '69'
  and F.OutputDiagnosis in (
      'K000','K001','K002','K003','K004','K005','K006','K007','K008','K009','K010','K011','K020','K021','K022','K023','K024','K025','K028','K029','K030','K031','K032','K033','K034','K035','K036',
      'K037','K038','K039','K040','K041','K042','K043','K044','K045','K046','K047','K048','K049','K050','K051','K052','K053','K054','K055','K056','K060','K061','K062','K068','K069','K070','K071','K072','K073','K074',
      'K075','K076','K078','K079','K080','K081','K082','K083','K088','K089','K090','K091','K092','K098','K099','K100','K101','K102','K103','K108','K109','K110','K111','K112','K113','K114','K115','K116','K117','K118',
