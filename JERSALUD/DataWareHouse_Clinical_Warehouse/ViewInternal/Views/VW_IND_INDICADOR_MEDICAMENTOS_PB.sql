...
-- Schema: ViewInternal
-- Object: VW_IND_INDICADOR_MEDICAMENTOS_PB
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_IND_INDICADOR_MEDICAMENTOS_PB  
AS
...
JOIN [INDIGO031].[dbo].[ADCENATEN] CA  ON OM.CODCENATE = CA.CODCENATE  --tabla identificada para lentitud de vista
...
LEFT OUTER JOIN [INDIGO031].[dbo].[INDIAGNOS] AS DX  ON DX.CODDIAGNO = OM.CODDIAGNO
LEFT OUTER JOIN [DataWareHouse_Clinical].[ViewInternal].[VW_IND_REDPROFESIONALES_JER] AS Red  ON prof.CODESPEC1 = Red.CODESPECI
...
INNER JOIN [INDIGO031].[dbo].[INPACIENT] AS B  ON B.IPCODPACI = OM.IPCODPACI 
