...
-- Schema: ViewInternal
-- Object: VW_RUTA_MATERNOPERINATAL_MICRONUTRIENTES
...
CREATE VIEW [ViewInternal].[VW_RUTA_MATERNOPERINATAL_MICRONUTRIENTES] AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2025' --and cups.Code in ('890301', '890201', '890101', '890350', '890250', '890205', '890305') 
and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING)between '14' and '49'/* DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) = '0'*/ and IPSEXOPAC=2  
