...
-- Schema: ViewInternal
-- Object: VW_RUTA_MATERNOPERINATAL_EMB14
...
CREATE VIEW [ViewInternal].[VW_RUTA_MATERNOPERINATAL_EMB14] AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2025' 
  ...
  and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) <= '14'  /*DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) = '0'*/ --
  and IPSEXOPAC=2  
