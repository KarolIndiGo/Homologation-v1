...
-- Schema: ViewInternal
-- Object: VW_METAS_JUVENTUD
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VW_METAS_JUVENTUD]
AS
...
case when F.OutputDiagnosis in ('Z000','Z008','Z108','Z136') and CUPS.Code in ('890263','890201') then 'Nroatenciones_GralJuventud' 
when F.OutputDiagnosis in ('Z000','Z008','Z108','Z136') and CUPS.Code in ('890263','890201') then 'Nroatenciones_GralJuventud2' 
...
and CUPS.Code in ('890203','890303') then 'Atenciones_BucalJuventud' 
					 when  CUPS.Code in ('892901') then 'Citologia' 
...
'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789') 
and CUPS.Code in ('903841','903895','903815','903816','903817','903818','903868','907106') then 'RiesgoCardioJuventud'

when 
--F.OutputDiagnosis in (...) 
--and 
CUPS.Code in ('997002') then 'ProfilaxisJuventud'

when 
--F.OutputDiagnosis in (...) 
--and 
CUPS.Code in ('997301') then 'DetratajesJuventud'

when  CUPS.Code in ('990201','990202','990203','990204','990205','990206','990207','990208','990209','990210','990211') then 'Educacion_IndividualJuventud'
when  CUPS.Code in ('990101', '990102','990103','990104','990105','990106','990107','990108','990109','990110','990111','990112','990113') then 'Educacion_GrupalJuventud'

					 end as Indicador , 'Juventud' as Grupo
...
'903841','903895','903815','903816','903817','903818','903868','907106') 
and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) >= '18'  and  DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) <= '28'  and 
...
,'Z123','Z124','Z000','Z008','Z108','Z136','I10X', 'E660', 'E668', 'E669','E100','E101','E102','E103','E104','E105','E106','E107','E108','E109','E110','E111','E112','E113','E114','E115',
'E116','E117','E118','E119','E120','E121','E122','E123','E124','E125','E126','E127','E128','E129','E130','E131','E132','E133','E134','E135','E136','E137','E138','E139','E140','E141','E142',
'E143','E144','E145','E146','E147','E148','E149','E15X','E160','E161','E162','E163','E164','E168','E169','E200','E201','E208','E209','E210','E211','E212','E213','E214','E215','E220','E221',
'E222','E228','E229','E230','E231','E232','E780','E781','E782','E783','E784','E785','E786','E788','E789')
