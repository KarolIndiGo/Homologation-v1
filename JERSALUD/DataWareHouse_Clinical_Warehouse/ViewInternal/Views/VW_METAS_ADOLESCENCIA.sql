...
-- Schema: ViewInternal
-- Object: VW_METAS_ADOLESCENCIA
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VW_METAS_ADOLESCENCIA]
AS
SELECT DISTINCT
       CASE
       ...
       case
           when F.OutputDiagnosis in ('Z000','Z008','Z003','Z108') and CUPS.Code in ('890283','890263','890201') then 'Nroatenciones_Adolescencia' 
           ...
           when CUPS.Code in ('997106','997103') then 'Barniz'
           when CUPS.Code in ('997002') then 'Profilaxis'
           when CUPS.Code in ('997107') then 'Sellantes'
           when CUPS.Code in ('997301') then 'Detartraje'
...
WHERE  (SOD.ServiceDate) >= '01/01/2024'
  ...
  and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) >= '12'
  and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) <= '17'
  and F.OutputDiagnosis in (
      'K000','K001','K002','K003','K004','K005','K006','K007','K008','K009','K010','K011','K020','K021','K022','K023','K024','K025','K028','K029','K030','K031','K032','K033','K034','K035','K036',
      'K037','K038','K039','K040','K041','K042','K043','K044','K045','K046','K047','K048','K049','K050','K051','K052','K053','K054','K055','K056','K060','K061','K062','K068','K069','K070','K071','K072','K073','K074',
      'K075','K076','K078','K079','K080','K081','K082','K083','K088','K089','K090','K091','K092','K098','K099','K100','K101','K102','K103','K108','K109','K110','K111','K112','K113','K114','K115','K116','K117','K118',
      'K119','K120','K121','K122','K123','K130','K131','K132','K133','K134','K135','K136','K137','K140','K141','K142','K143','K144','K145','K146','K148','K149','Z012','Z000','Z008','Z017','Z136','Z125','Z123','Z124','Z000','Z008','Z003','Z108','Z003','Z017'
  )
