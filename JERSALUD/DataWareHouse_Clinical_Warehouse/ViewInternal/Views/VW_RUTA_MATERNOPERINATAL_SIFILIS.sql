...
-- Schema: ViewInternal
-- Object: VW_RUTA_MATERNOPERINATAL_SIFILIS
...
CREATE VIEW [ViewInternal].[VW_RUTA_MATERNOPERINATAL_SIFILIS] AS
SELECT DISTINCT  
       CASE
...
WHERE  (SOD.ServiceDate) >= '2025-01-01' 
  and CUPS.Code in ('906039') 
