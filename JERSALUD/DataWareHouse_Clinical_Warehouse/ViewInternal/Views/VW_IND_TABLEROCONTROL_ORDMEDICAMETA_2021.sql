...
-- Schema: ViewInternal
-- Object: VW_IND_TABLEROCONTROL_ORDMEDICAMETA_2021
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [ViewInternal].[VW_IND_TABLEROCONTROL_ORDMEDICAMETA_2021] AS
     SELECT CodProf, 
            Profesional, 
            Especialidad, 
            CentroAtencion, 
     ...
     (
         ...
         WHERE ca.CODCENATE IN(010, 011, 012, 013, 014)
