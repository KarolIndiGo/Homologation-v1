...
-- Schema: ViewInternal
-- Object: VW_IND_TABLEROCONTROL_ORDMEDICAMETA_2022
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [ViewInternal].[VW_IND_TABLEROCONTROL_ORDMEDICAMETA_2022] AS
     SELECT CodProf, 
            Profesional, 
            Especialidad, 
            CentroAtencion, 
