...
-- Schema: ViewInternal
-- Object: VW_RUTA_MATERNOPERINATAL_MEDICAMENTOMICRONUTRIENTES
-- Extracted by Fabric SQL Extractor SPN v3.9.0



create VIEW [ViewInternal].[VW_RUTA_MATERNOPERINATAL_MEDICAMENTOMICRONUTRIENTES] as

SELECT DISTINCT  CASE
                 WHEN CA.CODCENATE IN(001,002, 003, 004, 005, 006, 007, 008, 009,017,021)
                THEN 'BOYACA'
            ...
            END AS Regional,  ING.IFECHAING AS FECHA_INGRESO, ING.NUMINGRES AS INGRESO, LTRIM(RTRIM(CA.NOMCENATE)) AS CENTRO_ATENCION, U.UFUDESCRI AS UNIDAD_FUNCIONAL,
				...
				case  when pr.Code in (select Codigo from INDIGO031.ViewInternal.InyectableTrimestral
										union all 
...
WHERE  (SOD.ServiceDate) >= '01/01/2025' and pr.Code in ('35662-11','35662-18','35662-16','19908845-8','19908845-4','20006387-4','20044614-4','30969-5','20005188-1',
'32897-22','19914806-6','20080792-20','20015204-3','19936177-4')  and IPSEXOPAC=2  
 and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING)between '14' and '49' and F.Status=1

--select *
--from INDIGO031.Inventory.InventoryProduct
--where ATCId in ('42',
--'251',
--'1289',
--'1290',
