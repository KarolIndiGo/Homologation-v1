...
-- Schema: ViewInternal
-- Object: VW_IND_PACIENTES
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_IND_PACIENTES 
AS
...
FROM [INDIGO031].[dbo].[INPACIENT] AS PA
    INNER JOIN [INDIGO031].[dbo].[INUBICACI] AS UB ON UB.AUUBICACI = PA.AUUBICACI
    LEFT JOIN [INDIGO031].[dbo].[ADDISCAPACI] AS DI ON PA.DISCCODIGO = DI.DISCCODIGO 