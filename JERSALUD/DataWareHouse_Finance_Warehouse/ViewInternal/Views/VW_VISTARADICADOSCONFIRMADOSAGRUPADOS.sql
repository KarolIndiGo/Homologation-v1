...
CREATE VIEW ViewInternal.VW_VISTARADICADOSCONFIRMADOSAGRUPADOS
as (
select 
...
inner join INDIGO031.Common.ThirdParty t on t.Id = ar.ThirdPartyId
inner join INDIGO031.GeneralLedger.MainAccounts ma on ma.Id = ar.AccountWithoutRadicateId
left join INDIGO031.Billing.Invoice i on i.InvoiceNumber = ar.InvoiceNumber
left join INDIGO031.Billing.InvoiceCategories ic on ic.Id = i.InvoiceCategoryId
