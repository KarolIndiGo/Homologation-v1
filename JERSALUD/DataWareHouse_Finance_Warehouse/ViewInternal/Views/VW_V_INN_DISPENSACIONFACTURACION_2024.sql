...
-- Schema: ViewInternal
-- Object: VW_V_INN_DISPENSACIONFACTURACION_2024
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_V_INN_DISPENSACIONFACTURACION_2024 AS
...
SELECT 
    ...
    CASE 
        ...
        WHEN (MONTH(D.DocumentDate)) = '11' THEN 'Nov24'
...
WHERE 
    (D.DocumentDate BETWEEN '2024-01-01 00:00:00' AND '2024-12-31 23:59:59')
    AND (D.Status = '2')
