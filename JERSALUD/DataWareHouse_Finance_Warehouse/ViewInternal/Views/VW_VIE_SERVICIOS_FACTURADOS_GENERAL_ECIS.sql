...
-- Schema: ViewInternal
-- Object: VW_VIE_SERVICIOS_FACTURADOS_GENERAL_ECIS
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_VIE_SERVICIOS_FACTURADOS_GENERAL_ECIS AS

SELECT DISTINCT --TOP 10 
--SOD.ApplyRIAS,SOD.RIASCupsId, 
ING.IFECHAING AS FECHA_INGRESO, ING.NUMINGRES AS INGRESO, ING.CODUSUCRE AS USUARIO_CREA, us.NOMUSUARI as UsuarioIngreso,LTRIM(RTRIM(CA.NOMCENATE)) AS CENTRO_ATENCION, U.UFUDESCRI AS UNIDAD_FUNCIONAL,
				...
				CASE F.DocumentType WHEN 1 THEN 'Factura EAPB con Contrato' WHEN 2 THEN 'Factura EAPB Sin Contrato' WHEN 3 THEN 'Factura Particular' WHEN 4 THEN 'Factura Capitada' 
				...
				RI.NOMBRE AS RIAS, CASE WHEN P.IPSEXOPAC = '1' THEN 'Masculino' WHEN P.IPSEXOPAC = '2' THEN 'Femenino' END AS Sexo,
				CASE
  ...
  FROM INDIGO031.Billing.Invoice AS F 
	   ...
	   LEFT JOIN INDIGO031.dbo.RIASCUPS AS RC ON RC.ID = SOD.RIASCupsId
	   LEFT JOIN INDIGO031.dbo.RIAS AS RI ON RC.IDRIAS = RI.ID
WHERE  (SOD.ServiceDate) >= '07/22/2024' and CUPS.Code in ('990101', '990102', '990104', '990106','990221', '990222', '990223', '990224', '990201', '990211', 
'990204', '990206', 'I10003', 'I10006', 'I10007', 'I10101', 'I10103', 'I10104', 'I10107', 'I10109', 'I10202', 'I10203', 'I10204', 'I10206', 'I10207', 
'I10209', 'I10301', 'I10304', 'I10307', 'I10308', 'I10402', 'I10408', 'I10412', 'I10413', 'I10604', 'I10605', 'I10601', 'I10602','990101', '990102', '990104', 
'990106', '990113') and GA.Name like '%ECIS%'
