...
-- Schema: ViewInternal
-- Object: VW_VIE_SERVICIOS_FACTURADOS_MEDICAMENTOS_2023_D
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_VIE_SERVICIOS_FACTURADOS_MEDICAMENTOS_2023_D
AS
...
JOIN INDIGO031.Payroll.FunctionalUnit as uf  on   uf.Id= DDIS.FunctionalUnitId
JOIN INDIGO031.Payroll.CostCenter as ccc    on ccc.Id= uf.CostCenterId
JOIN INDIGO031.dbo.ADCENATEN AS CEN ON CEN.CODCENATE=MF.CareCenterCode
...
JOIN INDIGO031.Payroll.CostCenter as cccd    on cccd.Id= DO.CostCenterId
...
JOIN INDIGO031.[Security].PermissionCompanyInt AS Perm ON Perm.IdUser = U.Id AND Perm.Permission = 1 AND Perm.IdContainer = 109
...
WHERE YEAR(FA.InvoiceDate)='2024' and DIS.Status<>3 and ING.IESTADOIN<>'A' 
