...
CREATE view [ViewInternal].[VW_VISTADIFERENCIALIBROS] as 
(
...
left join INDIGO031.Payroll.CostCenter cc on cc.Id = jvd.IdCostCenter
...
) as datacol inner join INDIGO031.GeneralLedger.HomologationAccount ha on ha.OfficialMainAccountId = datacol.IdMainAccount inner join INDIGO031.GeneralLedger.MainAccounts manif on manif.Id = ha.MainAccountId left join
(
