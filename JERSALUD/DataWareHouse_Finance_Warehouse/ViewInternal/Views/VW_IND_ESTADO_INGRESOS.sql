...
-- Schema: ViewInternal
-- Object: VW_IND_ESTADO_INGRESOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW ViewInternal.VW_IND_ESTADO_INGRESOS
AS
     SELECT CASE
            ...
            CASE
                WHEN I.UFUCODIGO LIKE 'B0%'  THEN 'Boyaca'
                WHEN I.UFUCODIGO LIKE 'Met%' THEN 'Meta'
                WHEN I.UFUCODIGO LIKE 'Yop%' THEN 'Casanare'
            END AS Regional,
            CASE I.IESTADOIN
