...
-- Schema: ViewInternal
-- Object: VW_CRI_INGRESOSABIERTOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_CRI_INGRESOSABIERTOS
AS
SELECT DISTINCT
    ...
    CASE I.IINGREPOR
        ...
        WHEN 5 THEN 'HospitalizacionURG'
    END AS IngresoPOR,
    CASE I.ICAUSAING
        WHEN 1 THEN 'Heridos en Combate'
        WHEN 2 THEN 'Enfermedad Profesional'
        WHEN 3 THEN 'Emfermedad General Adulto'
        WHEN 4 THEN 'Enfermedad General Pediatrica'
        WHEN 1 THEN 'Odontologia'
        WHEN 6 THEN 'Accidente de Transito'
        WHEN 7 THEN 'Catastrofe'
    END AS Causa,
    I.NUMINGRES,
