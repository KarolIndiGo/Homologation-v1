...
-- Schema: ViewInternal
-- Object: VW_CRI_INGRESOSANULADOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_CRI_INGRESOSANULADOS
AS
     SELECT DISTINCT 
     ...
     FROM [INDIGO031].[dbo].[INPACIENT] AS A 
          ...
          INNER JOIN [INDIGO031].[Billing].[ServiceOrder] AS O  ON O.AdmissionNumber = I.NUMINGRES
          INNER JOIN [INDIGO031].[Billing].[ServiceOrderDetail] AS OD  ON OD.ServiceOrderId = O.Id
