...
-- Schema: ViewInternal
-- Object: VW_V_CTN_ESTADOSFINANCIEROS_2020_INVENTARIO
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[VW_V_CTN_ESTADOSFINANCIEROS_2020_INVENTARIO] AS
     ...
     FROM INDIGO031.GeneralLedger.GeneralLedgerBalance AS B
          ...
          LEFT OUTER JOIN INDIGO031.Payroll.Contract AS CONT ON CONT.EmployeeId = E.Id
                                                                        AND CONT.Status = 1
          LEFT OUTER JOIN INDIGO031.Payroll.Position AS PO ON PO.Id = CONT.PositionId
     WHERE C.Number LIKE '611001%'
           AND C.IdAccountLevel = 6
           OR C.Number LIKE '411002%'
           AND C.IdAccountLevel = 6
           OR C.Number LIKE '429530%'
           AND C.IdAccountLevel = 6
           OR C.Number LIKE '5105700%'
           AND C.IdAccountLevel = 6
           OR C.Number LIKE '5105701%'
           AND C.IdAccountLevel = 6
