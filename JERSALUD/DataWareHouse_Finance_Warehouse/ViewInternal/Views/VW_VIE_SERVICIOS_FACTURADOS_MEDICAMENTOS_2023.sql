...
-- Schema: ViewInternal
-- Object: VW_VIE_SERVICIOS_FACTURADOS_MEDICAMENTOS_2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW ViewInternal.VW_VIE_SERVICIOS_FACTURADOS_MEDICAMENTOS_2023
as
select  
    AdmissionNumber
    , Factura
...
from [DataWareHouse_Finance].[ViewInternal].[VW_VIE_SERVICIOS_FACTURADOS_MEDICAMENTOS_2023_D] as M 
