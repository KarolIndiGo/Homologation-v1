...
-- ItemId: SPN
-- Schema: Report
-- Object: View_HDSAP_AUTORIZACION_SANITAS
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [Report].[View_HDSAP_Autorizacion_Sanitas]
AS
...
FROM            (SELECT                             '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador,PAC.IPNOMCOMP AS Nombre_Paciente,
                                                    ...
                                                    HCORDLABO.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS.DESCODCUPS AS Descripcion_Prestacion, 
                          ...
                          SELECT                   '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador,  PAC.IPNOMCOMP AS Nombre_Paciente,
                                                   ...
                                                   HCORDIMAG.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS_3.DESCODCUPS AS Descripcion_Prestacion, 
                          ...
                          SELECT                   '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador, PAC.IPNOMCOMP AS Nombre_Paciente, 
                                                   ...
                                                   HCORDPRON.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS_2.DESCODCUPS AS Descripcion_Prestacion, 
                          ...
                          SELECT                   '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador, PAC.IPNOMCOMP AS Nombre_Paciente,  
                                                   ...
                                                   HCORDPROQ.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS_1.DESCODCUPS AS Descripcion_Prestacion, 
						  ...
						  SELECT                   '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador, PAC.IPNOMCOMP AS Nombre_Paciente,  
                                                   ...
                                                   HCORDINTE.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS_3.DESCODCUPS AS Descripcion_Pretacion, 
						  ...
						  SELECT                   '415510047901' AS Código_Habilitación, 'E.S.E. Hospital Departamental San Antonio de Pitalito Huila' AS Nombre_del_Prestador, PAC.IPNOMCOMP AS Nombre_Paciente,
                                                   ...
                                                   HCORDPATO.CODSERIPS AS Código_CUPS_Prestacion, INCUPSIPS_3.DESCODCUPS AS Descripcion_Prestacion, 
