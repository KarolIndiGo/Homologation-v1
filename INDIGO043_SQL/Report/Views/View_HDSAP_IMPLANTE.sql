...
CREATE VIEW [Report].[View_HDSAP_IMPLANTE]
AS
...
SELECT    distinct
         ...
         CASE i.IPTIPODOC
						 ...
						 ad.IFECHAING 'Resultado Prueba de Embarazo previa a la inserción',
						 ad.IFECHAING 'Fecha Firma de Consentimiento Informado',
						 ad.IFECHAING 'Fecha Aplicación Implante',
						 ad.IFECHAING 'Fecha programada de Retiro del implante',
						   CASE 
							WHEN  n.CODENTIDA <> '999'
							then 'SI'
							end 'Afiliación confirmada'

FROM HCHOGASIN  A 
join ADINGRESO ad on ad.NUMINGRES = a.NUMINGRES
join HCKARDPAC c on c.NUMINGRES = a.NUMINGRES
