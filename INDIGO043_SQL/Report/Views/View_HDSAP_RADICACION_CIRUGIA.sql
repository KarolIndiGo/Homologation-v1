...
-- ItemId: SPN
-- Schema: Report
-- Object: View_HDSAP_RADICACION CIRUGIA
...
CREATE VIEW [Report].[View_HDSAP_RADICACION CIRUGIA]
AS
...
SELECT distinct
	...
	rad.CAMPOFECHA FechaAutorizacion,
	rad.CAMPOTEXTO 'Usuario Citas Recibe'
