...
CREATE VIEW [Report].[View_HDSAP_RADICADO]
AS
SELECT      DISTINCT  rc.RadicatedConsecutive AS Radicado, tp.Nit, tp.Name AS Entidad, ar.InvoiceNumber AS Factura, CASE RD.Devolution WHEN 1 THEN 'DEVOLUCION' WHEN 0 THEN 'FACTURADO POR PRIMERA VEZ' END ESTADOFACTURA,
                         ...
                         rc.CreationDate AS FecCreacion, EA.Name AS ENTIDADADMIN, CASE rc.state WHEN 1 THEN 'Sin Confirmar' WHEN 2 THEN 'Confirmado' END AS ESTADORADICADO, i.OutputDate FechaEgreso
