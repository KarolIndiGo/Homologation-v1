...
-- ItemId: SPN
-- Schema: Report
-- Object: View_HDSAP_CITASMEDICASCORREO
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [Report].[View_HDSAP_CITASMEDICASCORREO]
AS
     ...
     WHERE CIT.OBSERVACI IS NOT NULL
          AND CIT.OBSERVACI like'%@%';
