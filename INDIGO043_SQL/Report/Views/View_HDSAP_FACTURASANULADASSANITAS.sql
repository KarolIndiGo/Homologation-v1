...
-- ItemId: SPN
-- Schema: Report
-- Object: View_HDSAP_FACTURASANULADASSANITAS
...
CREATE VIEW [Report].[View_HDSAP_FACTURASANULADASSANITAS]
AS
...
SELECT         i.InvoiceNumber AS Factura, i.InvoiceDate AS ff, ad.IPCODPACI AS Cedula, pa.IPNOMCOMP AS Nombre, IPFECNACI as FecNacimiento, ad.NUMINGRES AS Ingreso,
               ad.IFECHAING AS f_ingreso, EGR.FECALTPAC AS f_alta_medica, 
                         ...
                         i.DescriptionReversal AS AnulaMotivo, Cat.Name AS Categoria
...
where  ha.Name like '%sanita%' --and i.InvoiceDate between '2024-02-28' and '2024-02-29'
