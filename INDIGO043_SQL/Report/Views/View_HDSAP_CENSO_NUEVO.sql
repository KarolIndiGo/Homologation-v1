...
CREATE VIEW [Report].[View_HDSAP_CENSO_NUEVO]
AS
...
WHEN 5 
THEN 'ODONTOLOGÍA 6 ACCIDENTE DE TRANSITO '
WHEN 7 
...
THEN ' MATERNIDAD '
WHEN 10
THEN 'ACCIDENTE LABORAL 11 CIRUGIA PROGRAMADA'
END 'CAUSA INGRESO',
