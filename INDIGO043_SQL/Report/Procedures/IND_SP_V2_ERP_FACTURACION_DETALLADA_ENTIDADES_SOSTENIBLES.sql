...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_ERP_FACTURACION_DETALLADA_ENTIDADES_SOSTENIBLES
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE PROCEDURE [Report].[IND_SP_V2_ERP_FACTURACION_DETALLADA_ENTIDADES_SOSTENIBLES] 
...
SELECT  CASE I.documentType WHEN '1' THEN 'Factura EAPB con Contrato' WHEN '2' THEN 'Factura EAPB Sin Contrato' WHEN '3' THEN 'Factura Particular' WHEN '4' THEN 'Factura Capitada ' WHEN '5' THEN 'Control de Capitacion' WHEN
                          '6' THEN 'Factura Basica' WHEN '7' THEN 'Factura de Venta de Productos' END AS TipoDocumento, ICT.Name AS Categoría, I.InvoiceNumber AS Factura,case I.[Status] when '1' THEN 'Facturado' when '2' then 'Anulado' end as 'Estado'
...
FROM
  ...
  WHERE ICT.CODE IN ('09','10') AND HA.Code IN ('E0058', 'E0060', 'EA0256', 'EA0307', 'EA0345', 'EA0075','EA0410','EA0020','EA0021','E0093','E0094','E0101','E0104','E0107','E0109','E0110','E0111','EA0002','EA0017',
'EA0025','EA0027','EA0055','EA0077','EA0096','EA0104','EA0105','EA0125','EA0126','EA0128','EA0134','EA0143','EA0146','EA0144','EA0145','EA0159','EA0161','EA0169','EA0172','EA0177','EA0310','EA0314','EA0317','EA0318',
'EA0320','EA0326','EA0327','EA0338','EA0341','EA0347','EA0350','EA0363','EA0365','EA0368','EA0390','EA0394','EA0397','EA0480','EA0483','EA0486','EA0497','EA0500','EA0503','EA0506','EA0509','EA0513','EA0514','EA0517',
'EA0518','EA0521','EA0530','EA0532','EA0538','EA0546','EA0547') ; 
