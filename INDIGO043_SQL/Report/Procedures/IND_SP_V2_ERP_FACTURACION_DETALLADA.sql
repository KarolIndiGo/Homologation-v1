...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_ERP_FACTURACION_DETALLADA
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE PROCEDURE [Report].[IND_SP_V2_ERP_FACTURACION_DETALLADA] 
...
SELECT  CASE I.documentType WHEN '1' THEN 'Factura EAPB con Contrato' WHEN '2' THEN 'Factura EAPB Sin Contrato' WHEN '3' THEN 'Factura Particular' WHEN '4' THEN 'Factura Capitada ' WHEN '5' THEN 'Control de Capitacion' WHEN
                          '6' THEN 'Factura Basica' WHEN '7' THEN 'Factura de Venta de Productos' END AS TipoDocumento, ICT.Name AS Categoría, I.InvoiceNumber AS Factura,ED.CUFE,case I.[Status] when '1' THEN 'Facturado' when '2' then 'Anulado' end as 'Estado'
...
FROM
	 ...
	 INNER JOIN BILLING.ElectronicDocument ED ON CONCAT(ED.Prefix,ED.DocumentNumber) = I.InvoiceNumber
