...
RM.Type 
 ...
 INNER JOIN Contract.DefinitionRate DR ON DR.Id =DRD.DefinitionRateId /*IN V2*/ --FN V2
...
(
 ...
 INNER JOIN Contract.DefinitionRateDetail DRD ON DRD.DefinitionRateId=DR.Id /*IN V2*/ AND DRD.RuleType=4 AND DR.Status=1--FN V2
...
(
 ...
 SELECT * FROM CTE_REGLA_SERVICIOS_IPS     --'013HCS' AND CUPS ='453306'
UNION ALL
 SELECT * FROM CTE_REGLA_CUPS-- AND CUPS ='453306'
UNION ALL
SELECT * FROM CTE_REGLA_SUBGRUPOS_CUPS  --'013HCS' AND CUPS ='453306'
UNION ALL
SELECT * FROM CTE_REGLA_GRUPOS_CUPS  --'013HCS' AND CUPS ='453306'
UNION ALL
 SELECT * FROM CTE_REGLA_GENERAL  --'013HCS' AND CUPS ='453306'
