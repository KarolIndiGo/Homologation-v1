...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: V_CTN_EstFin_Miomed_2025_NeivaPatologia
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[V_CTN_EstFin_Miomed_2025_NeivaPatologia] as
...
WHERE c.LegalBookId = '1' AND cco.Code = 'MMD31'
