...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_AD_Inventory_Devoluciones_SinConfirmar
-- Extracted by Fabric SQL Extractor SPN v3.9.0

create VIEW [ViewInternal].[VIE_AD_Inventory_Devoluciones_SinConfirmar]
AS
...
FROM      Inventory.PharmaceuticalDispensingDevolution AS i INNER JOIN
