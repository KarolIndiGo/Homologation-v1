...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_IndicadoresGralxProfesional_Medicamentos_CostoProm
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[IND_IndicadoresGralxProfesional_Medicamentos_CostoProm] as
     ...
     WHERE M.TIPPRODUC = 1
           AND om.FECINIDOS >= '01-01-2022'  AND om.NUMINGRES+NUMEFOLIO NOT IN (SELECT NUMINGRES+NUMEFOLIO
