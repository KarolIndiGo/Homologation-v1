...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_Servicios_Facturados_Medicamentos_2022
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [ViewInternal].[VIE_Servicios_Facturados_Medicamentos_2022] as
select  AdmissionNumber, Factura, Tipo_Documento_Facturado, IPS, Red, Formula, Id_Formula, Identificacion_Paciente, Nombre_Paciente, TipoProducto, Cod_Medicamento_Insumo, Medicamento_Insumo, CUM, Producto, CodeAlternativeTwo, Estado, ProdControl, AltoCosto, 
             ...
             Grupo_Atencion, Codigo_Grupo_Farmacologico, Grupo_Farmacologico, Presentation, Dpto, Municipio, Unidad_Operativa, m.Grupo, DifDiasDispVSFact, DifHorasDispVSFact, ProfesionOrdena, Codigo_DCI, DCI, Tipo_Liquidacion, CentroCostoDispensacion, CentroCostoFacturacion, 
            NumeroCtaCosto, CuentaCosto, NumeroCtaVenta, CuentaVenta, EstadoIngreso
from ViewInternal.[VIE_Servicios_Facturados_Medicamentos_2022_D] as M 
