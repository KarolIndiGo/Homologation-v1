...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_DiagnosticoPaciente
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[IND_DiagnosticoPaciente]
AS
     ...
     FROM dbo.INDIAGNOP AS DP
          INNER JOIN dbo.INDIAGNOS AS D ON DP.CODDIAGNO = D.CODDIAGNO
                                                             AND CONVERT(NVARCHAR(10), DP.FECDIAGNO, 20) > CONVERT(NVARCHAR(10), GETDATE() - 190, 20)
