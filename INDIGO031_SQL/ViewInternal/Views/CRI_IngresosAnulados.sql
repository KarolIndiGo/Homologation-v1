...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: CRI_IngresosAnulados
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [ViewInternal].[CRI_IngresosAnulados]
AS
     SELECT DISTINCT 
     ...
     (
         SELECT NOMUSUARI
         FROM dbo.SEGusuaru 
         WHERE CODUSUARI = I.CODUSUANU
     ) AS Usuario_Anula, 
            I.FECREGANU AS Fecha_Anulacion, 
            I.IJUSTIFIC,
            CASE I.IESTADOIN
                WHEN ''
     ...
     FROM dbo.INPACIENT AS A 
          ...
          INNER JOIN Billing.ServiceOrder AS O  ON O.AdmissionNumber = I.NUMINGRES
          INNER JOIN Billing.ServiceOrderDetail AS OD  ON OD.ServiceOrderId = O.Id
