...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_Interconsultas
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[IND_Interconsultas]
--ALTER VIEW [dbo].[IND_Interconsultas_Trimestral]
AS

SELECT IC.NUMINGRES AS Ingreso, 
            CA.NOMCENATE AS [Centro de Atencion], 
            IC.IPCODPACI AS [Documento Paciente], 
            PACI.IPNOMCOMP AS [Nombre Paciente], PACI.IPDIRECCI AS Direccion, PACI.IPTELEFON AS Fijo, PACI.IPTELMOVI AS Celular, 
