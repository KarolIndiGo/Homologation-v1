...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_IndicadoresGralxProfesional_Laboratorio_Tarifa_PB
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE view [ViewInternal].[IND_IndicadoresGralxProfesional_Laboratorio_Tarifa_PB] as
 ...
 SELECT 'Laboratorio' AS Tipo, 
   ...
   --        (I.CANSERIPS) AS Cant,
     ...
     FROM DBO.HCORDLABO I 
		...
		LEFT JOIN [ViewInternal].[Tarifas_Laboratorio] AS T ON T.Code=I.CODSERIPS
