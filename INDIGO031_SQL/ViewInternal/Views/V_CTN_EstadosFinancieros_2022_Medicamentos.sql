...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: V_CTN_EstadosFinancieros_2022_Medicamentos
...
CREATE VIEW [ViewInternal].[V_CTN_EstadosFinancieros_2022_Medicamentos]
AS
...
FROM   GeneralLedger.GeneralLedgerBalance AS B 
	   INNER JOIN GeneralLedger.MainAccounts AS C ON B.IdMainAccount = C.Id AND B.Year = '2022'
