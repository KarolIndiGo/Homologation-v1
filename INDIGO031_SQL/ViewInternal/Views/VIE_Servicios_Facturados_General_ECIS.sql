...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_Servicios_Facturados_General_ECIS
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VIE_Servicios_Facturados_General_ECIS] AS
...
ING.IFECHAING AS FECHA_INGRESO, ING.NUMINGRES AS INGRESO, ING.CODUSUCRE AS USUARIO_CREA, us.NOMUSUARI as UsuarioIngreso,LTRIM(RTRIM(CA.NOMCENATE)) AS CENTRO_ATENCION, U.UFUDESCRI AS UNIDAD_FUNCIONAL,
  ...
  FROM Billing.Invoice AS F 
	   ...
	   LEFT JOIN dbo.RIASCUPS AS RC ON RC.ID = SOD.RIASCupsId
	   LEFT JOIN dbo.RIAS AS RI ON RC.IDRIAS = RI.ID
