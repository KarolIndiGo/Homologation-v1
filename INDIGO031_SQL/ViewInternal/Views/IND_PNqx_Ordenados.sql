...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_PNqx_Ordenados
-- Extracted by Fabric SQL Extractor SPN v3.9.0


/****** Object:  View [dbo].[IND_LibroSintomaticosRespiratorios]    Script Date: 7/21/2022 4:05:56 PM ******/

--ALTER VIEW [dbo].[IND_PNqx_Ordenados_Trimestral]
CREATE VIEW [ViewInternal].[IND_PNqx_Ordenados]
as
