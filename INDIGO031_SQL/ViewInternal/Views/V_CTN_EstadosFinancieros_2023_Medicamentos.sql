...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: V_CTN_EstadosFinancieros_2023_Medicamentos
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[V_CTN_EstadosFinancieros_2023_Medicamentos]
AS
...
FROM   GeneralLedger.GeneralLedgerBalance AS B 
	   INNER JOIN GeneralLedger.MainAccounts AS C ON B.IdMainAccount = C.Id AND B.Year = '2023'
