...
SELECT   Ing.id AS IdIngreso, pa.AdquisitionDate AS FAdquisición, pa.Id AS id_activo, 
			--CASE WHEN l.Code LIKE 'C%' THEN 'Faca' WHEN l.Code LIKE 'B%' THEN 'Bogota' WHEN l.Code LIKE 'F%' THEN 'Florencia' WHEN l.Code LIKE 'n%' THEN 'Neiva' WHEN l.Code LIKE 'T%' THEN 'Tunja' WHEN l.Code LIKE 'P%' THEN 'Pitalito' WHEN l.Code LIKE 'M%' THEN 'Mocoa' END AS Sucursal, 
			CASE WHEN l.Code LIKE 'NVA%' THEN 'NEIVA' WHEN L.CODE LIKE 'BOG%' THEN 'BOGOTA' WHEN L.CODE='MET010201' THEN 'ACACIAS' WHEN L.CODE='MET010301' THEN 'GRANADA' WHEN L.CODE='MET010101' THEN 'VILLAVICENCIO' WHEN L.CODE='BOY010101' THEN 'TUNJA' ELSE L.Name END AS Sucursal, 
			Ing.Code AS Ingreso, 
			...
			RTRIM(Art.Description) AS [Artículo], 
			--CASE substring(tart.Code, 1, 2) WHEN '01' THEN 'TERRENOS' WHEN '02' THEN 'CONSTRUCCIONES EN CURSO' WHEN '03' THEN 'CONSTRUCCIONES Y EDIFICACIONES' WHEN '04' THEN 'MAQUINARIA Y EQUIPO' WHEN '05' THEN 'EQUIPO DE OFICINA' 
			--WHEN '06' THEN 'EQUIPO DE COMPUTO Y COMUNICACION' WHEN '07' THEN 'MAQUINARIA Y EQUIPO MEDICO CIENTIFICO' END AS TipoInventario, 
			cata.Description AS TipoInventario, 
			pa.Plate AS Placa, mar.Name AS Marca, pa.Model AS Modelo, pa.Serie, CASE pa.Status WHEN '1' THEN 'Activo' WHEN '0' THEN 'Inactivo' END AS EstadoActivo, RTRIM(t .Nit) + ' - ' + RTRIM(t .Name) AS Responsable, 
...
SELECT  ' ' AS IdIngreso, pa.AdquisitionDate AS FAdquisición, faibi.Id AS id_activo, 
           --CASE WHEN l.Code LIKE 'C%' THEN 'Faca' WHEN l.Code LIKE 'B%' THEN 'Bogota' WHEN l.Code LIKE 'F%' THEN 'Florencia' WHEN l.Code LIKE 'n%' THEN 'Neiva' WHEN l.Code LIKE 'T%' THEN 'Tunja' WHEN l.Code LIKE 'P%' THEN 'Pitalito' WHEN l.Code LIKE 'M%' THEN 'Mocoa' END AS Sucursal, 
		   CASE WHEN l.Code LIKE 'NVA%' THEN 'NEIVA' WHEN L.CODE LIKE 'BOG%' THEN 'BOGOTA' WHEN L.CODE='MET010201' THEN 'ACACIAS' WHEN L.CODE='MET010301' THEN 'GRANADA' WHEN L.CODE='MET010101' THEN 'VILLAVICENCIO' WHEN L.CODE='BOY010101' THEN 'TUNJA' ELSE L.Name END AS Sucursal,  
		   'SaldInic' + ' - ' + RTRIM(faib.Code) AS Ingreso, 
           ...
           RTRIM(fai.Description) AS [Artículo],
		   --CASE substring(tart.Code, 1, 2) WHEN '01' THEN 'TERRENOS' WHEN '02' THEN 'CONSTRUCCIONES EN CURSO' WHEN '03' THEN 'CONSTRUCCIONES Y EDIFICACIONES' WHEN '04' THEN 'MAQUINARIA Y EQUIPO' WHEN '05' THEN 'EQUIPO DE OFICINA' 
			--WHEN '06' THEN 'EQUIPO DE COMPUTO Y COMUNICACION' WHEN '07' THEN 'MAQUINARIA Y EQUIPO MEDICO CIENTIFICO' END AS TipoInventario, 
			cata.Description AS TipoInventario, 
			faibi.Plate AS 'Placa', mar.Name AS Marca, pa.Model AS Modelo, pa.Serie, 
...
select 0 AS IdIngreso, pa.AdquisitionDate AS FAdquisición, pa.Id AS id_activo, 
			...
			--WHEN l.Code LIKE 'M%' THEN 'Mocoa' END AS Sucursal, 
			CASE WHEN l.Code LIKE 'NVA%' THEN 'NEIVA' WHEN L.CODE LIKE 'BOG%' THEN 'BOGOTA' WHEN L.CODE='MET010201' THEN 'ACACIAS' WHEN L.CODE='MET010301' THEN 'GRANADA' WHEN L.CODE='MET010101' THEN 'VILLAVICENCIO' WHEN L.CODE='BOY010101' THEN 'TUNJA' ELSE L.Name END AS Sucursal, 
			'' AS Ingreso, 
			''  AS Estado, '' AS Fecha, 
			...
			--CASE substring(tart.Code, 1, 2) WHEN '01' THEN 'TERRENOS' WHEN '02' THEN 'CONSTRUCCIONES EN CURSO' WHEN '03' THEN 'CONSTRUCCIONES Y EDIFICACIONES' WHEN '04' THEN 'MAQUINARIA Y EQUIPO' WHEN '05' THEN 'EQUIPO DE OFICINA' 
			--WHEN '06' THEN 'EQUIPO DE COMPUTO Y COMUNICACION' WHEN '07' THEN 'MAQUINARIA Y EQUIPO MEDICO CIENTIFICO' END AS TipoInventario, 
			cata.Description AS TipoInventario,   pa.Plate AS Placa,
