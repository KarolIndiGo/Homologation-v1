...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: Detalle_Nota_Seguimiento_virtual_educacion
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[Detalle_Nota_Seguimiento_virtual_educacion]
AS
     SELECT DISTINCT 
            NP.ID,
            CASE P.IPTIPODOC
     ...
     (
         SELECT TVL.NOMBRE
         FROM dbo.NTNOTASADMINISTRATIVASD AS ND1
              LEFT JOIN dbo.NTVARIABLESL AS TVL ON TVL.CODIGO = ND1.VALOR
     ...
     (
         SELECT ND2.VALOR
         FROM dbo.NTNOTASADMINISTRATIVASD AS ND2
