...
CREATE VIEW [ViewInternal].[Informe_FIAS_17_18]
AS
/*
DPTO
MUNICIPIO
...
SELECT DISTINCT c.CODAUTONU as CodigoCita,
     ...
     FROM dbo.AGASICITA AS C 
          ...
          INNER JOIN dbo.INMUNICIP AS MUNI ON MUNI.DEPMUNCOD = CA.DEPMUNCOD
          INNER JOIN dbo.INDEPARTA AS DEP ON DEP.depcodigo = MUNI.DEPCODIGO
