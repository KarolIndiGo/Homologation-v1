...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: Ruta_MaternoPerinatal_VIH
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[Ruta_MaternoPerinatal_VIH] AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2024' and cups.Code in ('906249') and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) between '14' and '50' and IPSEXOPAC=2  
