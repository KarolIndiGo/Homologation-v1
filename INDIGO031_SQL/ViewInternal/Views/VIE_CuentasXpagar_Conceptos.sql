...
AS
     ...
     FROM Payments.AccountPayable AS p 
          ...
          LEFT OUTER JOIN Payments.AccountPayableDetailConcept AS DCxp  ON DCxp.IdAccountPayable = p.Id
          LEFT OUTER JOIN Payroll.CostCenter AS cc ON DCxp.IdCostCenter = cc.Id
          INNER JOIN GeneralLedger.MainAccounts AS c1 ON DCxp.IdAccount = c1.Id
          INNER JOIN Payments.AccountPayableConcepts AS Con ON DCxp.IdConceptAccountPayable = Con.Id
