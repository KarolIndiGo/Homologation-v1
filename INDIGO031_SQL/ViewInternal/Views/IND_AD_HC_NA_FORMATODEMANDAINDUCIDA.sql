...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: IND_AD_HC_NA_FORMATODEMANDAINDUCIDA
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[IND_AD_HC_NA_FORMATODEMANDAINDUCIDA] as
...
select 	nota.NOMBRE as Nota, c.FECHACREACION as [Fecha],    CASE
                ...
                THEN 'CASANARE'
            END AS Departamento, 
ce.nomcenate  as IPSPrimaria, P.IPPRINOMB AS [Primer Nombre], P.IPSEGNOMB AS [Segundo Nombre], P.IPPRIAPEL AS [Primer Apellido], 
