...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: Ruta_MaternoPerinatal_Den_Emb14
...
create VIEW [ViewInternal].[Ruta_MaternoPerinatal_Den_Emb14] AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2025' and cups.Code in ('890301', '890201', '890101', '890350', '890250', '890205', '890305') --and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) <= '14'  /*DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) = '0'*/ --
and IPSEXOPAC=2  
