...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: Ruta_MaternoPerinatal_Sifilis
-- Extracted by Fabric SQL Extractor SPN v3.9.0



create VIEW [ViewInternal].[Ruta_MaternoPerinatal_Sifilis] AS
...
WHERE  (SOD.ServiceDate) >= '01/01/2025' and cups.Code in ('906039') and DATEDIFF(year, P.IPFECNACI, ING.IFECHAING) between '14' and '50' and IPSEXOPAC=2  
