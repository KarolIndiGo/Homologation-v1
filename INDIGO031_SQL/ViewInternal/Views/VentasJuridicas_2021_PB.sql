...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VentasJuridicas_2021_PB
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VentasJuridicas_2021_PB]
AS
SELECT --'Jersalud' as Sede,
CASE
                WHEN cco.Code LIKE 'BOG%'
                THEN 'Bogota'
				 WHEN cco.Code LIKE 'MED%'
                THEN 'Medicamentos'
                WHEN cco.Code LIKE 'TAM%'
                THEN 'Bogota'
                WHEN cco.Code LIKE 'B00%'
                THEN 'Boyaca'
				WHEN cco.Code LIKE 'B0Y%'
                THEN 'Boyaca'
                WHEN cco.Code LIKE 'MET%'
                THEN 'Meta'
				WHEN cco.Code LIKE 'NVA%'
                THEN 'Neiva'
