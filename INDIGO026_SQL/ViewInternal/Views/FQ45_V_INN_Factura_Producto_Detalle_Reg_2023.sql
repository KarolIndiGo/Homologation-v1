...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_Reg_2023
...
CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_Reg_2023]
AS
...
WHERE        (FAC.Status = 1) AND (FAC.DocumentType = 7) AND year(FAC.InvoiceDate) = '2023'
