...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
...
WHERE (FAC.Status = 1) AND (FAC.DocumentType = 7) and  DOC.DocumentDate between '01/01/2020 00:00:00' and '31/12/2020 23:59:59'
