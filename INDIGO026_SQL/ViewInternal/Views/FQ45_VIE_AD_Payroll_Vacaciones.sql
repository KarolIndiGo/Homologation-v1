...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_VIE_AD_Payroll_Vacaciones
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_VIE_AD_Payroll_Vacaciones] AS 
SELECT        tp.Nit AS Documento, tp.Name AS Empleado, l.CreationDate AS [Fecha Liquidación], l.VacationDays AS [Dias Vacaciones], l.TakenDays AS [Dias Tomados], l.InitialDatePeriod AS [Fecha Inicial Periodo Vacaciones], 
                         l.EndDatePeriod AS [Fecha Final Periodo Vacaciones], v.VacationStartDate AS [Fecha inicial Disfrute], v.VacationEndDate AS [Fecha Final Disfrute], v.baseliquidation   AS BaseLiquidacion,fu.Code AS CodUFuncional, fu.Name AS UnidadFuncional, 
