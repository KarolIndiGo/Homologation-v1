...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Comprobante_entrada_devolucion_2022
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [ViewInternal].[FQ45_V_INN_Comprobante_entrada_devolucion_2022]
   AS
      SELECT pr.Code
                AS Nit,
             pr.Name
      ...
      WHERE (cce.Status = '2') AND (cce.InvoiceDate)>= '01-01-2022'
