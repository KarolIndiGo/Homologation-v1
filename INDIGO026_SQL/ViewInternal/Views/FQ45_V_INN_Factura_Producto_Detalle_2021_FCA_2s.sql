...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_2021_FCA_2s
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_2021_FCA_2s]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
...
WHERE (FAC.Status = 1) AND (FAC.DocumentType = 7) and  DOC.DocumentDate >'20210101' and CLI.id=2
