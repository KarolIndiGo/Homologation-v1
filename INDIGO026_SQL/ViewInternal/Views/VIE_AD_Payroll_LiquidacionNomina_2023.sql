...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_AD_Payroll_LiquidacionNomina_2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0

/****** Object:  View [dbo].[VIE_AD_Payroll_LiquidacionNomina_2023]    Script Date: 25/10/2023 7:53:05 p. m. *****
***** Object:  View [dbo].[VIE_AD_Payroll_LiquidacionNomina_2022]    Script Date: 10/05/2022 11:47:22 a. m. ******/
CREATE view [ViewInternal].[VIE_AD_Payroll_LiquidacionNomina_2023]
AS
SELECT DISTINCT 
                         ...
                         CASE WHEN YEAR(CONT.JobBondingDate) = YEAR('11/30/2018') AND MONTH(CONT.JobBondingDate) = MONTH('12/31/2018') THEN 'X' ELSE '' END AS ING, CASE WHEN YEAR(CONT.RetirementDate) = YEAR('11/30/2018') AND 
                         MONTH(CONT.RetirementDate) = MONTH('12/31/2018') THEN 'X' ELSE '' END AS RET, '' AS TDE, '' AS TAE, '' AS TDP, '' AS TAP, '' AS VSP, '' AS VTE, '' AS VST, CASE WHEN L.SanctionDays > 0 THEN 'X' ELSE '' END AS SAN, 
                         ...
                         + L.ParafiscalContribution + L.ProvisionsValue AS TotalNomina
...
WHERE        (L.PayrollDateLiquidated = '2023/12/31')
