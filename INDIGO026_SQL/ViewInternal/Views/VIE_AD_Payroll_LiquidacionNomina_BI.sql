...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_AD_Payroll_LiquidacionNomina_BI
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE view [ViewInternal].[VIE_AD_Payroll_LiquidacionNomina_BI] as
SELECT DISTINCT 
                         ...
                         + L.ParafiscalContribution + L.ProvisionsValue AS TotalNomina, L.PayrollDateLiquidated as Fecha
...
WHERE        (L.PayrollDateLiquidated = '2024/10/31')
