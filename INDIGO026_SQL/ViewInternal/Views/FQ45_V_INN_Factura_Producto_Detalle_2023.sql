...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_2023]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
...
WHERE  (FAC.DocumentType = 7) and  year(DOC.DocumentDate) ='2023' and  (month(DOC.DocumentDate) between '1' and '12')  --(FAC.Status = 1) Se quita del filtro el estado Facturado y se dejan los 2 estados (Facturado, Anulado)
