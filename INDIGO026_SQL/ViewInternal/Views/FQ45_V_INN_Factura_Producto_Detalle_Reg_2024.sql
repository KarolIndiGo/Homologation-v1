...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_Reg_2024
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_Reg_2024]
AS
...
WHERE        (FAC.Status = 1) AND (FAC.DocumentType = 7) AND year(FAC.InvoiceDate) = '2024'
