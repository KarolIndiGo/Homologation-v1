...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_ComprobanteEntrada_Jersalud
-- Extracted by Fabric SQL Extractor SPN v3.9.0

create VIEW [ViewInternal].[FQ45_V_INN_ComprobanteEntrada_Jersalud] AS
...
WHERE (cce.Status = '2') AND YEAR(cce.InvoiceDate)>='2023'
and al.code in (
'0087',
'0079',
'0089',
