...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_GeneralLedger_ComprobantesContables_2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [ViewInternal].[FQ45_GeneralLedger_ComprobantesContables_2023]
AS
...
WHERE year(coco.VoucherDate) = '2023' --AND (coco.VoucherDate <= '31/01/2019 23:59:00')
