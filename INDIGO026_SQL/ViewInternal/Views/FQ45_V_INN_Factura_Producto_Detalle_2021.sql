...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_2021
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_2021]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
...
WHERE (FAC.Status = 1) AND (FAC.DocumentType = 7) and  year(DOC.DocumentDate) ='2021'
