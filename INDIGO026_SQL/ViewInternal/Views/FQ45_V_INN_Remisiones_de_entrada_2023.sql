...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Remisiones_de_entrada_2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_V_INN_Remisiones_de_entrada_2023]
AS
...
WHERE (cr.Status <> '3') AND (cr.RemissionDate > '20221231')
