...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_AF_BajaActivos
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_AF_BajaActivos]
AS
SELECT CASE WHEN l.Code LIKE 'C%' THEN 'Faca' WHEN l.Code LIKE 'B%' THEN 'Bogota' WHEN l.Code LIKE 'F%' THEN 'Florencia' WHEN l.Code LIKE 'n%' THEN 'Neiva' WHEN l.Code LIKE 'T%' THEN 'Tunja' WHEN l.Code LIKE 'P%' THEN 'Pitalito' END AS
...
FROM     FixedAsset.FixedAssetActiveOutputDetail AS DB  INNER JOIN
                  ...
                  ViewInternal.FQ45_AF_ActivosFijos_New AS RA  ON RA.Placa = pa.Plate
