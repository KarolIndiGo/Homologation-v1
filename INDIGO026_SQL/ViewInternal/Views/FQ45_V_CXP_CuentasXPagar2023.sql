...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_CXP_CuentasXPagar2023
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[FQ45_V_CXP_CuentasXPagar2023]
AS
SELECT        e.Code AS Identificación, t.Nit, t.DigitVerification AS [Digito Verificacion], t.Name AS [Nombre Tercero], tp.Code, 
                         ...
                         c.Name AS [Descripción Cuenta Contable], p.Code AS [Consecutivo C x P], CASE p.IdOperatingUnit WHEN '5' THEN 'BOGOTA' WHEN '7' THEN 'CALI' END AS Sede, cb.Number AS [Nro Cuenta], 
