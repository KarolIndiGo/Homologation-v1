...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_2021pb
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_2021pb]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
       ...
       FAC.TotalInvoice
          AS [Valor Facturado],
          PRO.ProductCost as [Costo Promedio] ,
       PER.Fullname
          AS [User Creacion],
       PER1.Fullname
...
WHERE (FAC.Status = 1) AND (FAC.DocumentType = 7) and  DOC.DocumentDate >'31/12/2020 23:59:59'
