...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Remisiones_de_entrada_2021
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [ViewInternal].[FQ45_V_INN_Remisiones_de_entrada_2021]
AS
SELECT uo.UnitName AS Sede,
	   ...
	   case when DR.UnitValue*Pen.OutstandingQuantity =0 then 0 else DR.UnitValue*Pen.OutstandingQuantity end as VrPendiente
