...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_ComprobanteEntradaDevolucion
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [ViewInternal].[FQ45_V_INN_ComprobanteEntradaDevolucion]
AS
...
WHERE (cce.Status = '2') AND YEAR(cce.InvoiceDate)>='2025' --294876 --303668
