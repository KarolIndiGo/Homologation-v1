...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: FQ45_V_INN_Factura_Producto_Detalle_2022_2s
...
CREATE VIEW [ViewInternal].[FQ45_V_INN_Factura_Producto_Detalle_2022_2s]
AS
SELECT DOC.Code
          AS Documento,
       FAC.InvoiceNumber
...
WHERE (FAC.Status = 1) AND (FAC.DocumentType = 7) and  year(DOC.DocumentDate) ='2022' and  (month(DOC.DocumentDate) between '7' and '12')
