...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_AD_Ledger_BalanceGeneral2020
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [ViewInternal].[VIE_AD_Ledger_BalanceGeneral2020]
AS
     ...
     FROM GeneralLedger.GeneralLedgerBalance AS sc 
          ...
          LEFT OUTER JOIN GeneralLedger.MainAccounts AS c ON c.Id = sc.IdMainAccount  AND c.legalbookid = '2'  and (c.Number BETWEEN '1101010601' AND '3504010609') 
     ...
     WHERE(c.Number BETWEEN '1101010601' AND '350410601')
          AND (c.LegalBookId = '2')
   AND (sc.year = '2020' AND sc.month BETWEEN '1' AND '12') OR
           (sc.Year = '2019' AND month = '14') OR
           (sc.Year = '2021' AND month BETWEEN  '1' and '4')
     GROUP BY c.Number, 
              t.Nit, 
              t.Name, 
              cco.Code, 
