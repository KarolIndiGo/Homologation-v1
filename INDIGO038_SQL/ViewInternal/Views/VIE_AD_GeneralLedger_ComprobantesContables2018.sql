...
-- ItemId: SPN
-- Schema: ViewInternal
-- Object: VIE_AD_GeneralLedger_ComprobantesContables2018
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [ViewInternal].[VIE_AD_GeneralLedger_ComprobantesContables2018]
AS
     SELECT CASE
                WHEN CC.Code LIKE 'N%'
                THEN 'Neiva'
     ...
     WHERE(coco.VoucherDate >= '01/01/2018 00:00:00')
          AND (coco.VoucherDate <= '31/01/2018 23:59:00');
