...
-- ItemId: SPN
-- Schema: Report
-- Object: View_V2_FAC_REPORTE_TERAPIAS_POR_RECONOCER_HOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0


CREATE VIEW [Report].[View_V2_FAC_REPORTE_TERAPIAS_POR_RECONOCER_HOS]
AS

WITH CTE_TERAPIAS_UNICOS
----CTE PARA IDENTIFICAR LOS INGRESOS UNICOS DE TERAPIAS QUE ESTAN PENDIENTES DE RECONOCER - HOSPITALARIOS
AS
(
	...
	WHERE ING.TIPOINGRE=2 AND  ing.IESTADOIN in (' ','P') AND A.GENSERVICEORDER IS NULL 
  UNION ALL
	SELECT DISTINCT ING.NUMINGRES,ING.IPCODPACI,ING.IESTADOIN 
	 FROM dbo.HCPROCTER A 
	 INNER JOIN dbo.INCUPSIPS B ON A.CODSERIPS=B.CODSERIPS 
...
INNER JOIN Contract .CUPSEntity AS CUPS WITH (NOLOCK) ON CUPS.Id =SOD.CUPSEntityId AND CUPS.ServiceType IN (4) --CUPS.BillingGroupId IN  (17)
