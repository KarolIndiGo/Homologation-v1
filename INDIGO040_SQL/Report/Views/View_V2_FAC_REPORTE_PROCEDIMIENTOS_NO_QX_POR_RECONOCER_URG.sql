...
-- ItemId: SPN
-- Schema: Report
-- Object: View_V2_FAC_REPORTE_PROCEDIMIENTOS_NO_QX_POR_RECONOCER_URG
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [Report].[View_V2_FAC_REPORTE_PROCEDIMIENTOS_NO_QX_POR_RECONOCER_URG]
AS
...
(
  SELECT DISTINCT  ING.NUMINGRES ,ING.IPCODPACI,ING.IESTADOIN
	...
	WHERE ing.IESTADOIN in (' ','P') AND A.GENSERVICEORDER IS NULL AND A.ESTSERIPS NOT IN ('1','5') AND FUN.UFUTIPUNI ='1'
	AND A.CODSERIPS not in ('S55201','S55202','S55203','S55204','S55205','S55206','S55207','S55208','S55209','939403','931001',
    '937000','937101','937201','937202','937203','937300','937400','938303','938302','933501','893801','903883','S55000','903883') AND A.MANEXTPRO ='0'
	AND FUN.UFUTIPUNI ='1'
UNION ALL
	SELECT DISTINCT ING.NUMINGRES,ING.IPCODPACI,ING.IESTADOIN 
...
INNER JOIN Contract .CUPSEntity AS CUPS WITH (NOLOCK) ON CUPS.Id =SOD.CUPSEntityId AND CUPS.ServiceType IN (4,7,5)
...
AS
(
SELECT ING.NUMINGRES,A.NUMEFOLIO,A.IPCODPACI,P.IPNOMCOMP ,RTRIM(A.CODSERIPS) AS CODSERIPS,B.DESSERIPS,SUM(A.CANSERIPS) CANSERIPS,G.IESTADOIN,G.[CANTIDAD ORDENADA] ,
	...
	(
	    SELECT ING.NUMINGRES,A.IPCODPACI,P.IPNOMCOMP ,RTRIM(A.CODSERIPS) AS CODSERIPS,B.DESSERIPS,SUM(A.CANSERIPS)  'CANTIDAD ORDENADA',UNI.IESTADOIN
	     ...
	     WHERE A.ESTSERIPS NOT IN ('1','5') AND A.CODSERIPS not in ('S55201','S55202','S55203','S55204','S55205','S55206','S55207','S55208','S55209','939403','931001',
        '937000','937101','937201','937202','937203','937300','937400','938303','938302','933501','893801','903883','S55000','903883') AND A.MANEXTPRO ='0'
		AND FUN.UFUTIPUNI ='1'
	...
	WHERE A.ESTSERIPS NOT IN ('1','5') AND A.GENSERVICEORDER IS NULL AND A.CODSERIPS not in ('S55201','S55202','S55203','S55204','S55205','S55206','S55207','S55208','S55209','939403','931001',
    '937000','937101','937201','937202','937203','937300','937400','938303','938302','933501','893801','903883','S55000','903883') AND A.MANEXTPRO ='0'
	AND FUN.UFUTIPUNI ='1'
...
--AND (CAM.NUMCAMHOS LIKE 'U%' OR CAM.NUMCAMHOS LIKE 'O%' OR CAM.NUMCAMHOS LIKE 'SRE%') AND ING.DESSERIPS NOT LIKE 'INTERNAC%'
),
--IN V2
...
WHERE JUS.Code IS NULL AND NOQX.UFUDESCRI in ('PEDIATRIA URGENCIAS','URGENCIAS ADULTOS','PABELLON URGENCIAS ADULTOS','GINECOBSTETRICIA URGENCIAS')
--FN V2
