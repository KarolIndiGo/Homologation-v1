...
-- ItemId: SPN
-- Schema: Report
-- Object: View_V2_FAC_REPORTE_PROCEDIMIENTOS_QX_POR_RECONOCER_VALORIZADO
-- Extracted by Fabric SQL Extractor SPN v3.9.0




CREATE VIEW [Report].[View_V2_FAC_REPORTE_PROCEDIMIENTOS_QX_POR_RECONOCER_VALORIZADO]
AS
...
WHERE CUPS.ServiceType in (4,5) and year(cast(sod.ServiceDate as date))=2023
