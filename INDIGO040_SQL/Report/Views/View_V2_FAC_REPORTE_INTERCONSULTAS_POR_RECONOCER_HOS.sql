...
-- ItemId: SPN
-- Schema: Report
-- Object: View_V2_FAC_REPORTE_INTERCONSULTAS_POR_RECONOCER_HOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE VIEW [Report].[View_V2_FAC_REPORTE_INTERCONSULTAS_POR_RECONOCER_HOS]
AS
...
SELECT DISTINCT  ING.NUMINGRES ,ING.IPCODPACI,ING.IESTADOIN
  FROM dbo.ADINGRESO ing with (nolock)
	...
	WHERE ING.TIPOINGRE=2 AND  ing.IESTADOIN in (' ','P') AND A.GENSERVICEORDER IS NULL AND A.ESTSERIPS ='3' and A.MANEXTPRO ='0'
  UNION ALL
	SELECT DISTINCT ING.NUMINGRES,ING.IPCODPACI,ING.IESTADOIN 
...
INNER JOIN Contract .CUPSEntity AS CUPS WITH (NOLOCK) ON CUPS.Id =SOD.CUPSEntityId AND CUPS.ServiceType IN (6)--CUPS.BillingGroupId IN  (2)
...
HA.Name ENTIDAD, CG.Name 'GRUPO ATENCION',CAST(ING.IFECHAING AS DATE) 'FECHA INGRESO',
    ...
    FROM dbo.ADINGRESO ing with (nolock)
	    ...
	    (
		  ...
		  WHERE A.ESTSERIPS ='3' and A.MANEXTPRO ='0'
		...
		WHERE A.ESTSERIPS ='3' and A.MANEXTPRO ='0' AND A.GENSERVICEORDER IS NULL
