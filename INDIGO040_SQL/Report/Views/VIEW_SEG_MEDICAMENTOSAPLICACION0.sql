...
-- ItemId: SPN
-- Schema: Report
-- Object: VIEW_SEG_MEDICAMENTOSAPLICACION0
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE VIEW [Report].[VIEW_SEG_MEDICAMENTOSAPLICACION0] AS
SELECT --TOP 10
 ...
 HM.CANDESCON 'CANTIDAD APLICADA',
 UNI.DESUNIMED 'UNIDAD MEDICAMENTO',
 CASE HM.MEDESTADO WHEN 1 THEN 'Pendiente'
				   WHEN 2 THEN 'Aplicado'
				   WHEN 3 THEN 'Suspendido' END 'ESTADO APLICAICON',
...
LEFT JOIN dbo.INPROFSAL AS FE ON HM.CODPROAPL=FE.CODPROSAL
