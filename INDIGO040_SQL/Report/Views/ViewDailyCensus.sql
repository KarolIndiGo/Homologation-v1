...
SELECT distinct
 ...
 1 as 'CANTIDAD',
 CAST(EST.FECFINEST AS date) AS 'FECHA BUSQUEDA',
 YEAR(EST.FECFINEST) AS 'AÑO BUSQUEDA',
 MONTH(EST.FECFINEST) AS 'MES BUSQUEDA',
 CONCAT(FORMAT(MONTH(EST.FECFINEST), '00') ,' - ', 
	   CASE MONTH(EST.FECFINEST) 
	    WHEN 1 THEN 'ENERO'
   	    WHEN 2 THEN 'FEBRERO'
	    WHEN 3 THEN 'MARZO'
	    WHEN 4 THEN 'ABRIL'
