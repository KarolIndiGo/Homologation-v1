...
-- ItemId: SPN
-- Schema: Report
-- Object: UploadCubeVieFinanceInventoryKardex
...
Ovservaciones:
***********************************************************************************************************************************/
CREATE VIEW [Report].[UploadCubeVieFinanceInventoryKardex]
as
...
CAST(CON.DocumentDate AS DATE) AS [FECHA DOCUMENTO],
TER.NIT,
...
CON.[CUENTA X PAGAR / NOTA],
 ...
 MONTH(CON.DocumentDate) AS 'MES FECHA BUSQUEDA',
...
FORMAT(DAY(CON.DocumentDate), '00') AS 'DIA BUSQUEDA',
