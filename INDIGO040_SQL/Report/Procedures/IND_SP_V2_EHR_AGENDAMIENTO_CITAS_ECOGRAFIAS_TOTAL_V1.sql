...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_EHR_AGENDAMIENTO_CITAS__ECOGRAFIAS_TOTAL_V1
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE PROCEDURE [Report].[IND_SP_V2_EHR_AGENDAMIENTO_CITAS__ECOGRAFIAS_TOTAL_V1]
@FECHAINI DATE,
@FECHAFIN DATE
AS
...
WHERE CUPS.[DESCRIPCION CUPS] LIKE '%ECOGRAF%'
)
...
[GRUPO ATENCION CITA],[CODIGO CUPS],[DESCRIPCION CUPS],/*NULL [FECHA DE SOLICITUD],NULL [FECHA SOLICITA PACIENTE],NULL [FECHA DE CITA], NULL [OPORTUNIDAD DE CITA FS VS FAC],*/
...
--,CIT.[TIPO CITA],CIT.[TIPO CITA_SI],CIT.[TIPO CITA_NO]
...
LEFT JOIN 
 ...
 --WHERE --([TIPO CITA]='OTROS')
  --AND [UNIDAD FUNCIONAL] IN ('IMAGENOLOGIA APOYO DIAGNOSTICO','GINECOBSTETRICIA URGENCIAS')
