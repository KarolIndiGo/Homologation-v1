...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_EHR_PRODUCTIVIDAD_URGENCIAS_V1
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE PROCEDURE [Report].[IND_SP_V2_EHR_PRODUCTIVIDAD_URGENCIAS_V1]
...
--declare @FECHAINI AS DATE = '2025-01-01'
--declare @FECHAFIN AS DATE = '2025-01-31';
...
CTE_ORDENES_CON_ESTANCIA_RECONOCIDAS AS
 ( 
	...
	WHERE
	CUPS.Code IN ('890701','890702','890793','890703','890704')
...
CTE_ORDENES_CON_ESTANCIAS_CARGADAS AS
 ( 
  SELECT 
   ...
   G.[CONSULTA DE URGENCIAS POR ESPECIALISTA EN URGENCIAS],
               ...
               FROM
			    (SELECT
				 ...
				 FOR [DESCRIPCION CUPS] In ([CONSULTA DE URGENCIAS POR MEDICINA GENERAL], 
											...
											[CONSULTA DE URGENCIAS POR ESPECIALISTA EN URGENCIAS],
											...
											--where RC.AdmissionNumber='135633'
 ),
...
SELECT
 ...
 EST.[CONSULTA DE URGENCIAS POR ESPECIALISTA EN URGENCIAS],
...
FROM 
 ...
 LEFT JOIN CTE_ORDENES_CON_ESTANCIA_RECONOCIDAS REC  ON CAST(REC.AdmissionNumber AS CHAR) = CAST(I.NUMINGRES AS CHAR) 
 LEFT JOIN CTE_ORDENES_CON_ESTANCIAS_CARGADAS EST  ON CAST(EST.AdmissionNumber AS CHAR) = CAST(I.NUMINGRES AS CHAR)
