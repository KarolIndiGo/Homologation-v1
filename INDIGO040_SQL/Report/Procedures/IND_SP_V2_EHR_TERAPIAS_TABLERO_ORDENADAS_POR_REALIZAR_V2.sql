...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_EHR_TERAPIAS_TABLERO_ORDENADAS_POR_REALIZAR_V2
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE PROCEDURE [Report].[IND_SP_V2_EHR_TERAPIAS_TABLERO_ORDENADAS_POR_REALIZAR_V2]
AS
...
(
 ...
 CUPS.[DESCRIPCION CUPS], CD.Name 'DESCRIPCION RELACIONADA',TER.CANSERIPS 'CANTIDAD ORDENADA',MED.NOMMEDICO 'PROFESIONAL',ESP.DESESPECI 'ESPECIALIDAD',
 ...
 WHERE IM.Agrupador='Terapias' AND TER.MANEXTPRO=0 AND TER.ESTSERIPS NOT IN (2,5)
)
