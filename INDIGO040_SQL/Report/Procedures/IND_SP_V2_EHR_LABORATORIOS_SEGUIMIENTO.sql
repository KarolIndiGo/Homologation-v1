...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_EHR_LABORATORIOS_SEGUIMIENTO
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE PROCEDURE [Report].[IND_SP_V2_EHR_LABORATORIOS_SEGUIMIENTO] 
...
WHERE IDENTIFICACION =@IDENTIFICACION AND INGRESO =@INGRESO