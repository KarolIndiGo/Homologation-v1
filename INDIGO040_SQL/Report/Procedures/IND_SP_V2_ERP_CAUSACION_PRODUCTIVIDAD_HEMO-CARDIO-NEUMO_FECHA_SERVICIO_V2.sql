...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_ERP_CAUSACION_PRODUCTIVIDAD_HEMO-CARDIO-NEUMO_FECHA_SERVICIO_V2
-- Extracted by Fabric SQL Extractor SPN v3.9.0


--SET STATISTICS TIME ON;

CREATE PROCEDURE [Report].[IND_SP_V2_ERP_CAUSACION_PRODUCTIVIDAD_HEMO-CARDIO-NEUMO_FECHA_SERVICIO_V2]
...
(
  ...
  LEFT JOIN MedicalFees.MedicalFeesContract MFC WITH (NOLOCK) ON MFC.Id = HPC.MedicalFeesContractId
  WHERE SOD.RecordType=1 AND IM.Agrupador in ('Neumologia','Hemodinamia-Cardiologia')AND IM.ReportType ='Causacion'  AND CUPS.ServiceType  in (3,4,5,6,7,8) 
