...
Glosas.GlosaObjectionsReceptionC AS C ON G1.GlosaObjectionsReceptionCId = C.Id LEFT OUTER JOIN --INNER JOIN
...
(
 ...
 SELECT PA.Observations 'SALDO INICIAL','RECIBOS DE CAJA' 'TIPO',PA.Code 'FACTURA/RECIBO',
 ...
 CAST(ISNULL(CR.DocumentDate,PA.DocumentDate)AS DATE) 'FECHA FACTURA/RECIBO','1900-01-01' 'FECHA VENCIMIENTO','' 'NRO RADICADO', '' 'FECHA RADICADO',0 'DIAS CARTERA',
 '' 'EDAD CARTERA',0 'DIAS RADICADO', '' 'EDAD RADICADO',TP.Nit 'NIT',TP.Name 'ENTIDAD','' 'GRUPO ATENCION', PA.Value 'VALOR FACTURA/RECIBO',
