...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_ERP_PROCEDIMIENTOS_IMAGENES_CANTIDAD_CONFIGURACION
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE PROCEDURE [Report].[IND_SP_V2_ERP_PROCEDIMIENTOS_IMAGENES_CANTIDAD_CONFIGURACION] AS
...
FROM Billing.ServiceOrder AS SO
  ...
  WHERE IPSS.AssociatedMaterialIPSServiceId IS NOT NULL

)

SELECT * FROM CTE_CUPS_IPS_DET
--WHERE CUPS='851102'
 ORDER BY [CUPS],[CODIGO SERVICIO HOMOLOGO],[TIPO MANUAL],[CLASE DETQX]