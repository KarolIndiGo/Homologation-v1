...
-- ItemId: SPN
-- Schema: Report
-- Object: IND_SP_V2_ERP_PARAMETROS_MEDICAMENTOS
-- Extracted by Fabric SQL Extractor SPN v3.9.0



CREATE PROCEDURE [Report].[IND_SP_V2_ERP_PARAMETROS_MEDICAMENTOS] 

AS


SELECT DCI.Code 'CODIGO DCI',RTRIM(DCI.Name) 'DESCRIPCION DCI',ATCE.Code 'CODIGO ATC',RTRIM(ATCE.Name) 'DESCRIPCION ATC',ATC.Code 'CODIGO MEDICAMENTO',
RTRIM(ATC.Name) 'DESCRIPCION MEDICAMENTO',RTRIM(ATC.Concentration) 'CONCETRACION',RTRIM(PF.Name) 'FORMA FARMACEUTICA',RTRIM(AR.Name) 'VIA ADMINISTRACION',
...
CASE ATC.HighCost WHEN 0 THEN 'NO' WHEN 1 THEN 'SI' END 'MEDICAMENTO ALTO COSTO'
