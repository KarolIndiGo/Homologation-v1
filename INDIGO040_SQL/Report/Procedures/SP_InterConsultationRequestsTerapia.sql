...
-- ItemId: SPN
-- Schema: Report
-- Object: SP_InterConsultationRequestsTerapia
-- Extracted by Fabric SQL Extractor SPN v3.9.0


/*******************************************************************************************************************
Nombre: [Report].[SP_InterConsultationRequestsTerapia]
...
Fecha:
***********************************************************************************************************************************/
CREATE PROCEDURE Report.SP_InterConsultationRequestsTerapia
@FECINI DATE,
@FECFIN DATE
AS
...
WHERE [DESCRIPCION SERVICIO] LIKE '%TERAPIA%' AND [FECHA BUSQUEDA] BETWEEN @FECINI AND @FECFIN
