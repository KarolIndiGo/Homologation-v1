...
-- Schema: Report
-- Object: SP_VIEWEGRESOSHOSPITALARIOSBASEDEALTA
-- Extracted by Fabric SQL Extractor SPN v3.9.0

CREATE PROCEDURE Report.SP_VIEWEGRESOSHOSPITALARIOSBASEDEALTA
@FECINI AS DATE,
@FECFIN AS DATE
AS
...
WHERE
    CAST(CTUE.[FECHA EGRESO] as DATE) BETWEEN @FECINI AND @FECFIN;