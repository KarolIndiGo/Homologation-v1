...
/*******************************************************************************************************************
Nombre: [Report].[SP_AUT_ORDENES_AMBULATORIAS_AUTORIZACIONES_AUTORIZADOS_SIN_PROGRAMAR]
...
Fecha: 20-11-2024
Observaciones: Se comentarea la condición del Where "AGE.CUPS IS NULL AND CIR.CUPS IS NULL" 
para que nos genere el campo de "PROGRAMADO AGENDAMIENTO"
------------------------------------------------------------------------------------------------------
Version 2
...
AS
 ...
 --declare @FechaInicial DATETIME='2024-01-01'
 --declare @FechaFinal DATETIME ='2024-12-31';
...
TP.PatientCode 'IDENTIFICACION',PAC.IPNOMCOMP 'PACIENTE',PAC.IPTELEFON 'TELEFONO',PAC.IPTELMOVI 'CELULAR',PAC.IPDIRECCI 'DIRECCION',
tp.AdmissionNumber 'INGRESO' ,tp.Folio 'FOLIO' ,CASE CUPS.ServiceType WHEN 1 THEN 'Laboratorios' WHEN 2 THEN 'Patologias' WHEN 3 THEN 'Imagenes Diagnosticas'
  ...
  TP.RequestQuantity 'CANTIDAD ORDENADA' ,tp.RequestDate 'FECHA ORDEN','AUTORIZADO' 'ESTADO',
CASE TP.Status WHEN 5 THEN 'AUTORIZADO' WHEN 6 THEN 'AUTORIZADO EN ENTREGA' WHEN 7 THEN 'AUTORIZADO ENTREGADO' WHEN 8 THEN 'AUTORIZADO AGENDADO'
WHEN 9 THEN 'AUTORIZADO EJECUTADO' WHEN 10 THEN 'AUTORIZADO FACTURADO' WHEN 14 THEN 'AUTORIZADO REMITIDO' WHEN 15 THEN 'AUTORIZADO CON COTIZACION'
...
ISNULL(ING.CODDIAING,ING.CODDIAEGR) 'CIE10',DIA.NOMDIAGNO 'DIAGNOSTICO',ord.Observations as OBSERVACIONES
...
SELECT DISTINCT AUT.* ,IIF(ISNULL(AGE.CUPS,CIR.CUPS) IS NULL,'NO','SI') 'PROGRAMADO AGENDAMIENTO',
...
where  
cast(AUT.[FECHA ORDEN] as date) between @FechaInicial and @FechaFinal --AND 
--ISNULL(AGE.CUPS,CIR.CUPS) IS NULL
--AGE.CUPS IS NULL AND CIR.CUPS IS NULL
